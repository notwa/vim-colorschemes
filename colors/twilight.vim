...
hi javaScriptFuncDef ctermfg=228 ctermbg=NONE cterm=NONE guifg=#f9ee98 guibg=NONE gui=NONE
...
hi link javaScriptBrowserObjects cssRenderProp
hi link javaScriptLogicSymbols javaScriptOpSymbols
hi link javaScriptFuncArg sassVariable
hi link javaScriptThis sassVariable
hi link javaScriptNull cssValueLength
hi link javaScriptHtmlElemProperties cssValueLength
hi link javaScriptObjectKey rubyFunction
hi link javaScriptFuncKeyword javaScriptIdentifier
...
hi sassVariable ctermfg=68 ctermbg=NONE cterm=NONE guifg=#B1B3BA guibg=NONE gui=NONE
